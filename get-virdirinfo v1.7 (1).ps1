...
#
# Version History:  1.7     Updated build numbers to include more recent versions
...
function Get-VirDirInfo
{
    ...
    Process
    {
        ...
        $versionArray = @("Microsoft Exchange Server 2010 RTM","14.0.639.21"),
            ...
            ("Exchange Server 2013 Cumulative Update 5 (SP1 CU5)","15.0.913.22"),
            ("Exchange Server 2013 Cumulative Update 6 (SP1 CU5)","15.0.995.29"),
            ("Exchange Server 2013 Cumulative Update 7 (SP1 CU5)","15.0.1044.25"),
            ("Exchange Server 2013 Cumulative Update 8 (SP1 CU5)","15.0.1076.9"),
            ("Exchange Server 2013 Cumulative Update 9 (SP1 CU5)","15.0.1104.5"),
            ("Exchange Server 2013 Cumulative Update 10 (SP1 CU5)","15.0.1130.7"),
            ("Exchange Server 2013 Cumulative Update 11 (SP1 CU5)","15.0.1156.6"),
            ("Exchange Server 2013 Cumulative Update 12 (SP1 CU5)","15.0.1178.4"),
            #Exchange 2016
